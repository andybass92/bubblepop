...
//  BubblePop
//
//  Created by Andres Amarilis on 7/5/19.
//  Copyright © 2019 Andres Amarilis. All rights reserved.
//
...
class Bubble: UIButton {
    ...
    override init(frame: CGRect) {
        ...
        switch possibility {
        case 0...39:
            self.backgroundColor = #colorLiteral(red: 1, green: 0.2456468608, blue: 0.2472522621, alpha: 1)
            self.value = 1
        case 40...69:
